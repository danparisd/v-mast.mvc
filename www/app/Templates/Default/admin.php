...
Assets::css([
    ...
    template_url('css/style.css?123', 'Default'),
...
Assets::js([
    ...
    template_url('js/main.js?115', 'Default'),
    template_url('js/facilitator.js?37', 'Default'),
    template_url('js/autosize.min.js?3', 'Default'),
    template_url('js/admin.js?56', 'Default'),
