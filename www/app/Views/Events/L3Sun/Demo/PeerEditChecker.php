    ...
    <div class="help_float">
        <div class="help_info_steps is_checker_page_help isPeer">
            ...
            <div class="help_descr_steps">
                <ul><?php echo __("peer-edit-l3_chk_desc", ["step" => __($data["next_step"])])?></ul>
        ...
        <div class="checker_view">
            <a href="/events/demo-sun-l3/peer_edit_l3"><?php echo __("checker_other_view", [1]) ?></a>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function () {
        $("#next_step").click(function (e) {
            e.preventDefault();
            window.location.href = '/events/demo-sun-l3/pray';
            return false;
        });
