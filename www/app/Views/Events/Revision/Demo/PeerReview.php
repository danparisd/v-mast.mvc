                ...
                <div class="no_padding">
                    <div class="row chunk_block no_autosize flex_container">
                        <div class="chunk_verses flex_left" dir="ltr">
                            <p class="verse_text" data-verse="1"> <strong class="ltr"> <sup>1</sup> </strong> <b data="0">You</b> therefore, my child, be <b data="0">strengthened</b> in the <b data="0">grace</b> that is in <b data="0">Christ Jesus</b>.</p>
