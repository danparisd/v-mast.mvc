...
return array (
    ...
    "delete_warning" => "Ketik nama buku dan klik tombol \"Delete\" lagi untuk menghapus buku",
    ...
    "checker_apply" => "<b>{name}</b> sudah siap untuk diperiksa <b>{step}</b> buku <b>{book}</b>, pasal <b>{chapter}</b> - <b>{language}</b> - <b>{project}</b> {level}",
    ...
    "not_started_event_error" => "Penerjemahan belum dimulai. Anda dapat ke <a href=\"/activities/manage/{0}\">Kelola Buku</a> untuk menentukan penerjemah dan pasal dari buku.",
