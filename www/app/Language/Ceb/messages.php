...
return array (
    ...
    "checker_apply" => "<b>{name}</b> andam na para sa pagsusi <b>{step}</b> libro sa <b>{book}</b>, kapitulo <b>{chapter}</b> - <b>{language}</b> - <b>{project}</b> {level}",
    ...
    "not_started_event_error" => "Wala pa nasugdan ang paghubad. Mahimo kang mopadayon. Mahimo nga maodto ka <a href=\"/activities/manage/{0}\">Patan-aw sa Ginabuhat</a>sa ge-assign sa tighubad sa kapitulo sa maong libro.",
